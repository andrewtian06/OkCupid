...
//stateful class
class HasKidScreen extends Component {
  constructor(props){
      super(props);
      this.state = {
          Value: [
              {id:0 ,name: 'Has kid(s)', checked:false},
              {id:1 ,name: "Doesn't have kid(s)", checked:false},
            ]
      };
  }
  onchecked(id){
    ...
    return (
      <View style={styles.container}>
        <View style={styles.container4}>
          <Text style={styles.titleText}>Has kids</Text>
        </View>
