...
class ReligionScreen extends Component {
  constructor(props){
      ...
      this.state = {
          Value: [
              {id:0 ,name: 'Agnostic', checked:false},
              {id:1 ,name: 'Atheism', checked:false},
              {id:2 ,name: 'Christianity', checked:false},
              {id:3 ,name: 'Judaism', checked:false},
              {id:4 ,name: 'Catholicism', checked:false},
              {id:5 ,name: 'Islam', checked:false},
              {id:6 ,name: 'Hinduism', checked:false},
              {id:7 ,name: 'Buddhism', checked:false},
              {id:8 ,name: 'Sikh', checked:false},
              {id:9 ,name: 'Other religion', checked:false},
            ]
      };
  }
  onchecked(id){
