...
class OrientationScreen extends Component {
  constructor(props){
      ...
      this.state = {
          Value: [
              {id:0 ,name: 'Straight', checked:false},
              {id:1 ,name: 'Gay', checked:false},
              {id:2 ,name: 'Bisexual', checked:false},
              {id:3 ,name: 'Asexual', checked:false},
              {id:4 ,name: 'Demisexual', checked:false},
              {id:5 ,name: 'Homoflexible', checked:false},
              {id:6 ,name: 'Heteroflexible', checked:false},
              {id:7 ,name: 'Lesbian', checked:false},
            ]
      };
  }
  onchecked(id){
