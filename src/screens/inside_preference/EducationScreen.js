...
class EducationScreen extends Component {
  constructor(props){
      ...
      this.state = {
          Value: [
              {id:0 ,name: 'High school', checked:false},
              {id:1 ,name: 'Trade/tech school', checked:false},
              {id:2 ,name: 'In college', checked:false},
              {id:3 ,name: 'Undergraduate degree', checked:false},
              {id:4 ,name: 'In grad school', checked:false},
              {id:5 ,name: 'Graduate degree', checked:false},
            ]
      };
  }
  onchecked(id){
