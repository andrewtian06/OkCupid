...
class EthnicityScreen extends Component {
  constructor(props){
      ...
      this.state = {
          Value: [
              {id:0 ,name: 'Asian', checked:false},
              {id:1 ,name: 'Black', checked:false},
              {id:2 ,name: 'Hispanic/Latin', checked:false},
              {id:3 ,name: 'Indian', checked:false},
              {id:4 ,name: 'Middle Eastern', checked:false},
              {id:5 ,name: 'Native American', checked:false},
              {id:6 ,name: 'Pacific Islander', checked:false},
              {id:7 ,name: 'White', checked:false},
              {id:8 ,name: 'Other ethnicity', checked:false},
            ]
      };
  }
  onchecked(id){
    ...
    return (
      <View style={styles.container}>
        <View style={styles.container4}>
          <Text style={styles.titleText}>Preferred Ethnicity</Text>
        </View>
