...
//stateful class
class EmploymentScreen extends Component {
  constructor(props){
      super(props);
      this.state = {
          Value: [
              {id:0 ,name: 'Employed full-time', checked:false},
              {id:1 ,name: 'Employed part-time', checked:false},
              {id:2 ,name: 'Freelance worker', checked:false},
              {id:3 ,name: 'self-employed', checked:false},
              {id:4 ,name: 'Unemployed', checked:false},
              {id:5 ,name: 'Retired', checked:false},
            ]
      };
  }
  onchecked(id){
    ...
    return (
      <View style={styles.container}>
        <View style={styles.container4}>
          <Text style={styles.titleText}>Employment</Text>
        </View>
