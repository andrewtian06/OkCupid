...
class DietScreen extends Component {
  constructor(props){
      ...
      this.state = {
          Value: [
              {id:0 ,name: 'Omnivore', checked:false},
              {id:1 ,name: 'Vegetarian', checked:false},
              {id:2 ,name: 'Vegan', checked:false},
              {id:3 ,name: 'Kosher', checked:false},
              {id:4 ,name: 'Halal', checked:false},
              {id:5 ,name: 'Gluten free', checked:false},
              {id:6 ,name: 'Pescatarian', checked:false},
              {id:7 ,name: 'Jain', checked:false},
              {id:8 ,name: 'Lactovegetarian', checked:false},
              {id:9 ,name: 'Intermittent fasting', checked:false},
              {id:10 ,name: 'Ketogenic', checked:false},
            ]
      };
  }
  onchecked(id){
