...
//stateful class
class WantKidScreen extends Component {
  constructor(props){
      super(props);
      this.state = {
          Value: [
              {id:0 ,name: 'Might want kid(s)', checked:false},
              {id:1 ,name: "Wants kid(s)", checked:false},
              {id:2 ,name: "Doesn't want kid(s)", checked:false},
            ]
      };
  }
  onchecked(id){
    ...
    return (
      <View style={styles.container}>
        <View style={styles.container4}>
          <Text style={styles.titleText}>Wants kids</Text>
        </View>
